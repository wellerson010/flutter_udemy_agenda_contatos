...
class ContactHelper {
  ...
  Future<Database> initDb() async{
    ...
    final path = join(databasePaths, "contacts3.db");
  ...
  Future<List<Contact>> getAllContacts() async {
    Database dbContact = await db;
    List contacts = await dbContact.rawQuery('select * from $contactTable');
   List<Contact> contactsData = contacts.map((m) => Contact.fromMap(m)).toList();
